...
def fix_compliance_readme_links():
    ...
    fixes = [
        ('standards/compliance/oscal/README.md', '../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../docs/standards/UNIFIED_STANDARDS.md'),
        ('standards/compliance/examples/README.md', '../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../docs/standards/UNIFIED_STANDARDS.md'),
        ('standards/compliance/src/README.md', '../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../docs/standards/UNIFIED_STANDARDS.md'),
        ('standards/compliance/semantic/README.md', '../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../docs/standards/UNIFIED_STANDARDS.md'),
        ('standards/compliance/scripts/README.md', '../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../docs/standards/UNIFIED_STANDARDS.md'),
        ('standards/compliance/automation/README.md', '../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../docs/standards/UNIFIED_STANDARDS.md'),
        ('standards/compliance/oscal/catalogs/README.md', '../../../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../../docs/standards/UNIFIED_STANDARDS.md'),
        ('standards/compliance/oscal/profiles/README.md', '../../../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../../docs/standards/UNIFIED_STANDARDS.md'),
        ('standards/compliance/oscal/types/README.md', '../../../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../../docs/standards/UNIFIED_STANDARDS.md'),
        ('standards/compliance/src/parsers/README.md', '../../../../../../docs/standards/UNIFIED_STANDARDS.md', '../../../../docs/standards/UNIFIED_STANDARDS.md'),
    ]
...
def fix_nist_docs():
    ...
    if nist_ref.exists():
        ...
        content = re.sub(r'\.\.\./standards/COMPLIANCE_STANDARDS\.md', '../../docs/standards/COMPLIANCE_STANDARDS.md', content)
    ...
    if nist_guide.exists():
        ...
        content = re.sub(r'\.\.\./standards/MODERN_SECURITY_STANDARDS\.md', '../../docs/standards/MODERN_SECURITY_STANDARDS.md', content)
        content = re.sub(r'\.\.\./standards/PROJECT_MANAGEMENT_STANDARDS\.md', '../../docs/standards/PROJECT_MANAGEMENT_STANDARDS.md', content)
        content = re.sub(r'\.\.\./standards/UNIFIED_STANDARDS\.md', '../../docs/standards/UNIFIED_STANDARDS.md', content)
...
def fix_badges_readme():
    ...
    if badges.exists():
        ...
        if not (ROOT / 'docs/standards-compliance.md').exists():
            ...
            content = re.sub(r'\[View Full Standards Compliance Report →\]\([^)]+\)', 'View Full Standards Compliance Report', content)
