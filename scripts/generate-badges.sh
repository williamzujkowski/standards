...
[![Code Coverage](https://img.shields.io/badge/coverage-${COVERAGE}%25-brightgreen.svg)](https://github.com/williamzujkowski/standards/blob/master/docs/standards/TESTING_STANDARDS.md)
[![Security](https://img.shields.io/badge/security-${SECURITY_SCORE}-brightgreen.svg)](https://github.com/williamzujkowski/standards/blob/master/docs/standards/MODERN_SECURITY_STANDARDS.md)
\`\`\`

## Quality Metrics

\`\`\`markdown
[![Lighthouse](https://img.shields.io/badge/lighthouse-${LIGHTHOUSE_SCORE}-brightgreen.svg)](https://github.com/williamzujkowski/standards/blob/master/docs/standards/SEO_WEB_MARKETING_STANDARDS.md)
