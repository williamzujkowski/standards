...
def update_hub_file(hub_path: Path, pattern: str, files: List[Path]):
    ...
    # Skip STANDARDS_INDEX.md as it's generated by generate_standards_index.py
    if hub_path.name == "STANDARDS_INDEX.md":
        print(f"  ⏭️  Skipping generated file: {hub_path.relative_to(ROOT)}")
        return
