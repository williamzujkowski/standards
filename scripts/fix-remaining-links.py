...
def fix_nist_links():
    ...
    if nist_guide.exists():
        ...
        content = re.sub(
            r"\.\.?/\.\.?/standards/COMPLIANCE_STANDARDS\.md", "../standards/COMPLIANCE_STANDARDS.md", content
        )
        content = re.sub(
        ...
        content = re.sub(
            r"\.\.?/\.\.?/standards/MODERN_SECURITY_STANDARDS\.md", "../standards/MODERN_SECURITY_STANDARDS.md", content
        )
        content = re.sub(
            r"\.\.?/\.\.?/standards/PROJECT_MANAGEMENT_STANDARDS\.md",
            "../standards/PROJECT_MANAGEMENT_STANDARDS.md",
            content,
        )
