...
description: "Implements Zero Trust architectures, audits supply chain dependencies via SBOM generation, integrates SAST/DAST scanning into CI/CD pipelines, and hardens container deployments. Use when the user asks about Zero Trust, supply chain security, SBOM, DevSecOps pipelines, container hardening, API security, secrets management, or cloud-native security patterns."
---
