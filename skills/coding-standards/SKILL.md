...
description: "Enforces naming conventions, code formatting, function structure, error handling patterns, and documentation standards for Python, TypeScript, JavaScript, Go, and Java. Use when the user asks about code style, naming conventions, linting setup, formatting rules, refactoring strategies, code review checklists, or language-specific best practices."
---
