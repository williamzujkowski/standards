...
- **[COMPLIANCE_STANDARDS.md](./docs/standards/COMPLIANCE_STANDARDS.md)** - Detailed tagging standards
...
- [CLOUD_NATIVE_STANDARDS](./docs/standards/CLOUD_NATIVE_STANDARDS.md)
- [CODING_STANDARDS](./docs/standards/CODING_STANDARDS.md)
- [COMPLIANCE_STANDARDS](./docs/standards/COMPLIANCE_STANDARDS.md)
- [CONTENT_STANDARDS](./docs/standards/CONTENT_STANDARDS.md)
- [COST_OPTIMIZATION_STANDARDS](./docs/standards/COST_OPTIMIZATION_STANDARDS.md)
- [DATABASE_STANDARDS](./docs/standards/DATABASE_STANDARDS.md)
- [DATA_ENGINEERING_STANDARDS](./docs/standards/DATA_ENGINEERING_STANDARDS.md)
- [DEVOPS_PLATFORM_STANDARDS](./docs/standards/DEVOPS_PLATFORM_STANDARDS.md)
- [EVENT_DRIVEN_STANDARDS](./docs/standards/EVENT_DRIVEN_STANDARDS.md)
- [FRONTEND_MOBILE_STANDARDS](./docs/standards/FRONTEND_MOBILE_STANDARDS.md)
- [GITHUB_PLATFORM_STANDARDS](./docs/standards/GITHUB_PLATFORM_STANDARDS.md)
- [KNOWLEDGE_MANAGEMENT_STANDARDS](./docs/standards/KNOWLEDGE_MANAGEMENT_STANDARDS.md)
- [LEGAL_COMPLIANCE_STANDARDS](./docs/standards/LEGAL_COMPLIANCE_STANDARDS.md)
- [MICROSERVICES_STANDARDS](./docs/standards/MICROSERVICES_STANDARDS.md)
- [ML_AI_STANDARDS](./docs/standards/ML_AI_STANDARDS.md)
- [MODEL_CONTEXT_PROTOCOL_STANDARDS](./docs/standards/MODEL_CONTEXT_PROTOCOL_STANDARDS.md)
- [MODERN_SECURITY_STANDARDS](./docs/standards/MODERN_SECURITY_STANDARDS.md)
- [OBSERVABILITY_STANDARDS](./docs/standards/OBSERVABILITY_STANDARDS.md)
- [PROJECT_MANAGEMENT_STANDARDS](./docs/standards/PROJECT_MANAGEMENT_STANDARDS.md)
- [SEO_WEB_MARKETING_STANDARDS](./docs/standards/SEO_WEB_MARKETING_STANDARDS.md)
- [TESTING_STANDARDS](./docs/standards/TESTING_STANDARDS.md)
- [TOOLCHAIN_STANDARDS](./docs/standards/TOOLCHAIN_STANDARDS.md)
- [WEB_DESIGN_UX_STANDARDS](./docs/standards/WEB_DESIGN_UX_STANDARDS.md)

<!-- /AUTO-LINKS -->
<!-- AUTO-LINKS:docs/standards/**/*.md -->

- [Cloud Native Standards](./docs/standards/CLOUD_NATIVE_STANDARDS.md)
...
- [Cost Optimization Standards](./docs/standards/COST_OPTIMIZATION_STANDARDS.md)
- [Database Standards](./docs/standards/DATABASE_STANDARDS.md)
- [Data Engineering Standards](./docs/standards/DATA_ENGINEERING_STANDARDS.md)
- [Devops Platform Standards](./docs/standards/DEVOPS_PLATFORM_STANDARDS.md)
- [Event Driven Standards](./docs/standards/EVENT_DRIVEN_STANDARDS.md)
- [Frontend Mobile Standards](./docs/standards/FRONTEND_MOBILE_STANDARDS.md)
- [Github Platform Standards](./docs/standards/GITHUB_PLATFORM_STANDARDS.md)
- [Knowledge Management Standards](./docs/standards/KNOWLEDGE_MANAGEMENT_STANDARDS.md)
- [Legal Compliance Standards](./docs/standards/LEGAL_COMPLIANCE_STANDARDS.md)
- [Microservices Standards](./docs/standards/MICROSERVICES_STANDARDS.md)
- [Ml Ai Standards](./docs/standards/ML_AI_STANDARDS.md)
- [Model Context Protocol Standards](./docs/standards/MODEL_CONTEXT_PROTOCOL_STANDARDS.md)
- [Modern Security Standards](./docs/standards/MODERN_SECURITY_STANDARDS.md)
- [Observability Standards](./docs/standards/OBSERVABILITY_STANDARDS.md)
- [Project Management Standards](./docs/standards/PROJECT_MANAGEMENT_STANDARDS.md)
- [Readme](README.md)
- [Seo Web Marketing Standards](./docs/standards/SEO_WEB_MARKETING_STANDARDS.md)
- [Testing Standards](./docs/standards/TESTING_STANDARDS.md)
- [Toolchain Standards](./docs/standards/TOOLCHAIN_STANDARDS.md)
- [Web Design Ux Standards](./docs/standards/WEB_DESIGN_UX_STANDARDS.md)
